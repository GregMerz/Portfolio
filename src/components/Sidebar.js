...
function Sidebar({ scroll }) {
    ...
    return (
        <SidebarContainer scroll={scroll}>
            ...
            <SidebarWrapper> 
                <SidebarLink href="https://www.linkedin.com/in/greg-merz-228756198/" target="_blank">
                ...
                <SidebarLink href="https://mail.google.com/mail/u/0/#inbox?compose=CllgCJZWxDcgmwcZfBrXKZSvzjmCWfwGXRpFWFlFsMKnHQhngNWVBPZFDXSMjDRcBxDlswszbBB" target="_blank">
